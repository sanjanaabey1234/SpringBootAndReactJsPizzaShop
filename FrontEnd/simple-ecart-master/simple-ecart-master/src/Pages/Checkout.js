...
const[method,setCardmethod]=useState('')
...
const handleClick=(e)=>{
    ...
    e.preventDefault()
    const orders={name,email,number,address,district,method,productname}
    console.log(orders)
                                    ...
                                    <form>
                                            <div>
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="billing-email-address" placeholder="Enter email" value={email}
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="email" class="form-control" id="billing-email-address" placeholder="Enter email" value={email}
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="billing-phone" placeholder="Enter Phone no." value={number}
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="billing-address" placeholder="Enter full address" value={address}
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <label class="form-label" for="billing-District">District</label>
                                                            <input type="text" class="form-control" id="billing-phone" placeholder="Enter District" value={district}
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-4 mb-lg-0">
                                                            ...
                                                            <input type="text" class="form-control" id="billing-city" placeholder="Enter City" value={method}
                                                            onChange={(e)=>setCardmethod(e.target.value)}/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="mb-0">
                                                            ...
                                                            <input type="text" class="form-control" id="zip-code" placeholder="Enter Postal code" value={productname}
                                                            onChange={(e)=>setProductname(e.target.value)}/>
                                                        </div>
                                                    </div>
                                                    
                                                    <div>
                                                    <Button variant="contained" color="secondary" onClick={handleClick}>Place Order</Button>
                                                    </div>
